...
(function() {
    ...
    /**
     * @ngdoc module
     * @name selectAutocompleteSample
     */
    angular.module('selectAutocompleteSample', ['selectAutocomplete']);

    /**
     * @ngInject
     * @ngdoc controller
     * @name SelectAutocompleteSampleCtrl
     */
    angular.module('selectAutocompleteSample').controller('SelectAutocompleteSampleCtrl', function ($scope, $http) {
         ...
         * @returns {string}
         */
        $scope.selectedItemDecorator = function(user) {
